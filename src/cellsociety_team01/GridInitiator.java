...
public class GridInitiator {
	...
	public GridInitiator(Grid grd, double xDim, double yDim, double stateA, double stateB, double stateC, double stateD, double stateE, Element root, String xmlFilename) {
		grid = grd;
		xDim = xSize;
		yDim = ySize;
		stateA = stateOne;
